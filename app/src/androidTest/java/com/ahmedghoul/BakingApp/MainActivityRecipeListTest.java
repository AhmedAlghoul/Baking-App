...
import com.ahmedghoul.BakingApp.activities.MainActivity;
...
/**
 * Created by Mohamed AbuHasna  on 20/10/18.
 */
...
public class MainActivityRecipeListTest {
    ...
    public void checkText_MainActivity() {
        ...
        onView(ViewMatchers.withId(com.developers.bakingapp.R.id.recipe_recycler_view)).perform(RecyclerViewActions.scrollToPosition(1));
